namespace ShellSpy.Common.Interop
{
    internal static partial class Shell32
    {
        ...
        /// through IShellItem::GetDisplayName and SHGetNameFromIDList.
        /// </summary>
        public enum SIGDN : uint
        {
            ...
            /// When an item does not have a file system path, a call to IShellItem::GetDisplayName 
            /// on that item will fail. 
            /// In UI this name is suitable for display 
            ...
            /// This name is suitable for display to the user in some cases, but 
            ...
            /// <summary>
            /// Returns the path relative to the parent folder. Introduced in Windows 8.
            /// </summary>
